 ...
 * Log a message to `logger` at `level`.  
 * The logical location at which the message was generated is given by module `_module` and `group`, 
 * the source location by `file` and `line`
